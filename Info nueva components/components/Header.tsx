...
export default function Header({ onUserClick, onAllServicesClick, onReviewsClick, onHowItWorksClick }: HeaderProps) {
  return (
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-14 sm:h-16">
          ...
          <nav className="hidden md:flex space-x-6 lg:space-x-8">
            ...
            <a href="#contacto" className="text-gray-900 hover:text-primary transition-colors">
              Contacto
            </a>
          </nav>
            ...
            <Sheet>
              ...
              <SheetContent className="w-[300px] sm:w-[350px]">
                ...
                <div className="flex flex-col space-y-6 mt-8">
                  ...
                  <a href="#contacto" className="text-lg py-2 hover:text-primary transition-colors">
                    Contacto
                  </a>
