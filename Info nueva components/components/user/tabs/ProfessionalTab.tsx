        ...
        <CardContent className="space-y-6">
          <div className="grid grid-cols-2 gap-4">
            <div className="space-y-2">
              ...
              <Select 
                ...
                onValueChange={(value) => setProfessionalForm(prev => ({...prev, specialty: value}))}
              >
                <SelectTrigger>
            ...
            <div className="space-y-2">
              ...
              <Select 
                ...
                onValueChange={(value) => setProfessionalForm(prev => ({...prev, experience: value}))}
              >
                <SelectTrigger>
          ...
          <div className="space-y-2">
            ...
            <Textarea
              ...
              onChange={(e) => setProfessionalForm(prev => ({...prev, description: e.target.value}))}
              rows={3}
            />
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Select 
                ...
                onValueChange={(value) => setProfessionalForm(prev => ({...prev, durationType: value}))}
              >
                <SelectTrigger>
                  <SelectValue />
                </SelectTrigger>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => setProfessionalForm(prev => ({...prev, fixedDuration: parseInt(e.target.value)}))}
                    min="30"
                    max="480"
                  />
                </div>
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => setProfessionalForm(prev => ({...prev, pricePerHour: parseInt(e.target.value)}))}
                    min="10000"
                    step="1000"
                  />
                </div>
              ...
              <div className="grid grid-cols-3 gap-4">
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => setProfessionalForm(prev => ({...prev, minDuration: parseInt(e.target.value)}))}
                    min="30"
                    max="240"
                  />
                </div>
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => setProfessionalForm(prev => ({...prev, maxDuration: parseInt(e.target.value)}))}
                    min="60"
                    max="480"
                  />
                </div>
                ...
                <div className="space-y-4">
                  <div className="grid grid-cols-2 gap-4">
                    <div className="space-y-2">
                      ...
                      <Select 
                        ...
                        onValueChange={(value) => setTempServiceData(prev => ({...prev, specialty: value}))}
                      >
                        <SelectTrigger>
                          <SelectValue />
                        </SelectTrigger>
                    ...
                    <div className="space-y-2">
                      ...
                      <Select 
                        ...
                        onValueChange={(value) => setTempServiceData(prev => ({...prev, experience: value}))}
                      >
                        <SelectTrigger>
                          <SelectValue />
                        </SelectTrigger>
                  ...
                  <div className="space-y-2">
                    ...
                    <Textarea
                      ...
                      onChange={(e) => setTempServiceData(prev => ({...prev, description: e.target.value}))}
                      rows={3}
                    />
                  </div>
                  ...
                  <div className="space-y-4">
                    <div className="space-y-2">
                      ...
                      <Select 
                        ...
                        onValueChange={(value) => setTempServiceData(prev => ({...prev, durationType: value}))}
                      >
                        <SelectTrigger>
                          <SelectValue />
                        </SelectTrigger>
                      ...
                      <div className="grid grid-cols-2 gap-4">
                        <div className="space-y-2">
                          ...
                          <Input
                            ...
                            onChange={(e) => setTempServiceData(prev => ({...prev, fixedDuration: parseInt(e.target.value)}))}
                          />
                        </div>
                        <div className="space-y-2">
                          <Label>Precio total (CLP)</Label>
                          <Input
                            ...
                            onChange={(e) => setTempServiceData(prev => ({...prev, pricePerHour: parseInt(e.target.value)}))}
                          />
                        </div>
                      </div>
                    ) : (
                      <div className="grid grid-cols-3 gap-4">
                        <div className="space-y-2">
                          ...
                          <Input
                            ...
                            onChange={(e) => setTempServiceData(prev => ({...prev, minDuration: parseInt(e.target.value)}))}
                          />
                        </div>
                        <div className="space-y-2">
                          <Label>Max (min)</Label>
                          <Input
                            ...
                            onChange={(e) => setTempServiceData(prev => ({...prev, maxDuration: parseInt(e.target.value)}))}
                          />
                        </div>
                        <div className="space-y-2">
                          <Label>Precio total (CLP)</Label>
