...
export default function ProfessionalTabMultiService({ 
  ...
  const handleRemoveService = (serviceId: string) => {
    ...
    const updatedProfile = {
      ...userProfessionalProfile,
      services: userProfessionalProfile.services.filter(service => service.id !== serviceId)
    }
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <Textarea
                    ...
                    onChange={(e) => setInitialProfessionalForm(prev => ({
                      ...prev,
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <Select
                    ...
                    onValueChange={(value) => setInitialProfessionalForm(prev => ({
                      ...prev,
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <Select
                    ...
                    onValueChange={(value: 'fixed' | 'range') => setInitialProfessionalForm(prev => ({
                      ...prev,
      ...
      <Tabs value={professionalTab} onValueChange={setProfessionalTab}>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <Select
                      ...
                      onValueChange={(value: 'fixed' | 'range') => setNewServiceForm(prev => ({
                        ...prev,
                        durationType: value
                      }))}
                    >
                      ...
                      <div className="space-y-4">
                        <div>
                          ...
                          <Select
                            ...
                            onValueChange={(value: 'fixed' | 'range') => setEditServiceForm(prev => ({
                              ...prev,
                              durationType: value
                            }))}
                          >
        ...
        <TabsContent value="schedule">
          <ProfessionalScheduleManager 
            professionalId={userProfessionalProfile.id}
            onScheduleUpdate={() => {}}
          />
        </TabsContent>
      </Tabs>
